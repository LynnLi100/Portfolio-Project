 ...
 * FlexibleNumber.
 */
public class FlexibleNumberProof {
...
//constructors
     ...
     *          base
     */
    public FlexibleNumberProof(int number, int base) {
     ...
     * @param base
     */
    public FlexibleNumberProof(String number, int base) {
        assert base >= MIN_BASE : "base is less than 2";
        assert base <= MAX_BASE : "base is larger than 36";
        this.base = base;
        this.rep = "";
     ...
     */
    public FlexibleNumberProof(FlexibleNumberProof n) {
...
//
    ...
    public static void main(String[] args) {
        FlexibleNumberProof n = new FlexibleNumberProof("100001", 2);
